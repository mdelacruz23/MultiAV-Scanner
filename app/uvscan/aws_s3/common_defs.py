...
uvscan_engine_tmp_dir = "/tmp/" + ENGINE_PREFIX + "/" + SCANNER_NAME
UVSCAN_ENGINE_TMP_DIR = os.getenv("UVSCAN_ENGINE_PATH", uvscan_engine_tmp_dir)
UVSCAN_ENGINE_DIR = "/var/opt/uvscan_engine"

DEFS_PREFIX = os.getenv("DEFS_PREFIX", "scanners_defs")
tmp_dir = "/tmp/" + DEFS_PREFIX + "/" + SCANNER_NAME
UVSCAN_TMP_DIR = os.getenv("UVSCAN_DEFS_PATH", tmp_dir)
UVSCAN_INSTALL_DIR = "/app/uvscan"
# prefixes and suffixes will be specified when we get the package
UVSCAN_ENGINE_FILE_PREFIXES = "uvscan"
UVSCAN_ENGINE_FILE_SUFFIXES = ""

UVSCAN_DEFS_FILE_PREFIXES = ["avvdat", "avvdat-*"]
UVSCAN_DEFS_FILE_SUFFIXES = (".ini", ".zip")
