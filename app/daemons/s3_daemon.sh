...
### BEGIN INIT INFO
# Provides:          S3 VS scanner
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: A S3 VS multi-scanner 
# Description:       The service to virus scan S3 objects from S3 bucket
### END INIT INFO

DIR=/app/scanners
DAEMON=/usr/local/bin/python 
DAEMON_NAME=multiav_s3_scanner
DAEMON_OPTS=$DIR/multiav_s3_scanner.py
DAEMON_USER=mvs
