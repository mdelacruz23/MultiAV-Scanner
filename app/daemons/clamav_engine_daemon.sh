...
### BEGIN INIT INFO
# Provides:          Clam AntiVirus: Engine Updater
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Clam AntiVirus: Engine Updater
# Description:       The service to periodically update clamav engine with new version
### END INIT INFO

DIR=/app/clamav
DAEMON=/usr/local/bin/python 
DAEMON_NAME=clamav_engine_updater
DAEMON_OPTS="$DIR/clamav_engine_updater.py -d"
DAEMON_USER=mvs
