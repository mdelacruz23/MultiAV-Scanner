...
### BEGIN INIT INFO
# Provides:          McAfee AntiVirus: Database Updater
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: McAfee AntiVirus: Database Updater
# Description:       The service to periodically update McAfee db with virus definitions`
### END INIT INFO

DIR=/app/uvscan
DAEMON=/usr/local/bin/python 
DAEMON_NAME=mcafee_updater
DAEMON_OPTS="$DIR/uvscan_updater.py -d"
DAEMON_USER=mvs
